...
* @description
*/
public class StockReturnListDataServiceImpl extends UnicastRemoteObject implements SaleUniDataService {
	 ...
	 */
	protected StockReturnListDataServiceImpl() throws RemoteException {
		super();
