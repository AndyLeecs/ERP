...
# <center>灯具进销存系统</center>
# <center>软件体系结构描述</center>
# <center>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;V1.0 正式版<center>

## <center>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;CuteGroup </center> 

## <center>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;2017-10-22</center>
...
<img src="参照体系结构风格的包图表达逻辑视角.png" height = 500 width = 400>  

<center>**图1 参照体系结构风格的包图表达逻辑视角**</center>  

<img src="软件体系结构逻辑设计方案.png" height = 500 width = 400>  
...
<img src="客户端开发包图.png" height = 800 width = 800>  
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;**图3 灯具进销存系统客户端开发包图**  
<img src="服务器端开发包图.png" height = 800 width = 800>  
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;**图4 灯具进销存系统服务器端开发包图**  

###### &nbsp;&nbsp;&nbsp;&nbsp; 4.2 运行时进程
&nbsp;&nbsp;&nbsp;&nbsp;在灯具进销存系统中，会有多个客户端进程和一个服务器端进程，其进程图如图5所示。结合部署图，客户端进程是在客户端机器上运行，服务器端进程在服务器端机器上运行。  
<img src="进程图.png" height = 500 width = 400>  
<center>**图5 进程图**</center>  
...
<img src="部署图.png" height = 500 width = 400>  
<center>**图6 部署图**</center>  

###### 5. 接口视角

###### &nbsp;&nbsp;&nbsp;&nbsp; 5.1 模块的职责
&nbsp;&nbsp;&nbsp;&nbsp;客户端模块和服务器端模块视图分别如图7和图8所示。客户端各层和服务器端各层的职责分别如表2和表3所示。  
<img src="客户端模块视图.png" height = 300 width = 300>  
<center>图7 客户端模块视图</center>  
<img src="服务器端模块视图.png" height = 300 width = 300>  
<center>图8 服务器端模块视图</center>  

<center>**表2 客户端各层的职责**</center>    
...
<img src="用户界面跳转.png" height = 700 width = 600>   
<center>图10 用户界面跳转</center>  

服务器端和客户端的用户界面设计接口是一致的，只是具体的页面不一样。用户界面类如图11所示。  
![](用户界面类.png)  
<center>图11 用户界面类</center>  
...
<td>语法</td> <td>public void saveInitAccountInfo(InitAccountVO) </td>
</tr>
<tr>
...
<td>语法</td> <td>public boolean addAccount(AccountVO vo);</td>
</tr>
<tr>
<td>前置条件</td> <td>财务人员增加账户</td>
</tr>
<tr>
...
<td>语法</td> <td>public boolean deleteAccount(String name);</td>
</tr>
<tr>
...
<tr>
<td rowspan="3">Accountbl.saveAccount</td>
<td>语法</td> <td>public void saveAccount(String name，AccountVO vo);</td>
</tr>
<tr>
...
<tr>
<td rowspan="3">Accountbl.searchAccount</td>
<td>语法</td> <td>public List<AccountVO> searchAccount(String keyword);</td>
</tr>
<tr>
<td>前置条件</td> <td>财务人员输入关键字进行模糊查找账户</td>
</tr>
<tr>
<td>后置条件</td><td>返回符合条件的账户列表</td>
</tr>
<tr>
<td rowspan="3">Accountbl.createList</td>
...
<tr>
<td rowspan="3">Accountbl.openDraftList</td>
...
<tr>
<td rowspan="3">Accountbl.openList</td>
<td>语法</td> <td>public Map<ListType,String> openList(ListType type, String id);</td>
</tr>
<tr>
<td>前置条件</td> <td>无</td>
</tr>
...
<tr>
<td rowspan="3">Accountbl.saveList</td>
<td>语法</td> <td>public void saveList(ListType type, PaymentListVO);</td>
</tr>
<tr>
...
<tr>
<td rowspan="3">Accountbl.searchMember</td>
<td>语法</td> <td>public Map<String,String> searchMember(int id, String name)</td>
</tr>
<tr>
<td>前置条件</td> <td>输入会员id和姓名进行模糊查找</td>
</tr>
<tr>
<td>后置条件</td><td>返回所有符合条件的会员列表</td>
</tr>
<tr>
<td rowspan="3">Accountbl.getMember</td>
<td>语法</td> <td>public MemberVO getMember(int id)</td>
</tr>
<tr>
<td>前置条件</td> <td>无</td>
</tr>
...
<td>语法</td> <td>public AccountVO getAccount(String AccountName);</td>
</tr>
<tr>
<td>前置条件</td> <td>启动一个收款／付款／现金费用回合</td>
</tr>
<tr>
<td>后置条件</td><td>返回银行账户信息</td>
</tr>
<tr>
<td rowspan="3">Accountbl.commitList</td>
<td>语法</td> <td>public void commitList(ListType type, PaymentListVO);</td>
</tr>
<tr>
